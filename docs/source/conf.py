...
latex_documents = [
    (master_doc, ' pytest-image-diff.tex', ' pytest-image-diff Documentation',
     'Apkawa', 'manual'),
]
...
man_pages = [
    (master_doc, ' pytest-image-diff', ' pytest-image-diff Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (
        master_doc, ' pytest-image-diff', ' pytest-image-diff Documentation',
        author, 'pytest-image-diff', 'One line description of project.',
        'Miscellaneous'),
]
